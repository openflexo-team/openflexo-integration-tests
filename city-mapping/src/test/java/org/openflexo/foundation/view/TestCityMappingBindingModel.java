...
public class TestCityMappingBindingModel extends OpenflexoProjectAtRunTimeTestCase {
	...
	private static FlexoBehaviour syncScheme;
	...
	public void checkSynchronizationScheme() {
		...
		assertNotNull(cityMapping);
				...
				// The synchronization scheme is now a plain FML method: SynchronizationScheme is a
		// deprecated notion and textual FML has no way to declare one.
		syncScheme = cityMapping.getFlexoBehaviour("synchronization");
