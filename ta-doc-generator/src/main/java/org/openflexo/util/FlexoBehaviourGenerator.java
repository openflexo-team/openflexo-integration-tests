 ...
 * 
 */
public class FlexoBehaviourGenerator<FB extends FlexoBehaviour> extends AbstractGenerator<FB> {
	...
	public void generate() {
		...
		sb.append("# <tt>" + getObjectClass().getSimpleName() + "</tt> &nbsp; " + getBigIconAsHTML() + StringUtils.LINE_SEPARATOR);
